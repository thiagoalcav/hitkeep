...
@Component({
    ...
    imports: [CommonModule, ReactiveFormsModule, ButtonModule, SelectModule, SplitButtonModule, SettingsCard, SettingsSecurity, PageHeader, PageBreadcrumb, TranslocoPipe],
