...
func registerCloudFlags(
	...
	defCloudMaxMonthlyEvents := getInt64("HITKEEP_CLOUD_MAX_MONTHLY_EVENTS", 10000)
	...
	fs.Int64Var(&conf.CloudMaxMonthlyEvents, "cloud-max-monthly-events", defCloudMaxMonthlyEvents, "Managed cloud max monthly events per team")
