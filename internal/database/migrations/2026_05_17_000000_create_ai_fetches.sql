-- Shared and tenant analytics databases both contain a local sites table, so we
-- keep the foreign key in both migration trees for consistent referential safety.
