...
func openAPIV1AccountSchemas() map[string]any {
	return map[string]any{
		...
		"SystemAIStatus": map[string]any{
			...
			"required": []string{"status", "enabled", "configured", "config_mode", "base_url_configured", "requests_used", "request_limit", "tokens_used", "token_limit", "budget_window_minutes", "budget_exhausted"},
		},
