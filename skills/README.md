...
This directory contains official HitKeep Agent Skills for AI assistants and humans working with HitKeep analytics.
...
These skills work best with the official HitKeep MCP server configured. The skill pack teaches the agent how to reason about HitKeep data; the MCP server provides scoped, read-only aggregate analytics and official docs tools.
